title @s title {"text":"Mystic Weapons","color":"white"}
...
title @s title {"text":"Seek MYSTIC Weapons?","color":"yellow"}
title @s subtitle {"text":"Seek thee MYSTIC Weapons?","color":"yellow"}
