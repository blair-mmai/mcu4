...
There's no tutorial. No quest log. No boss. The world has to teach you how to be in it.

---

Built with Minecraft 26.x datapacks (mcfunction, loot tables, advancements, scoreboards).  
See [spoilers/](spoilers/) if you want to know how it works before playing.
